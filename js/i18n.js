...
export const STRINGS = {
  ...
  "chef.l4":    { zh: "每次取胜按结束方式得一到三分，赢下整场再加两分。",
    py: ["měi","cì","qǔ","shèng","àn","jié","shù","fāng","shì","dé","yì","dào","sān","fēn","yíng","xià","zhěng","chǎng","zài","jiā","liǎng","fēn"],
    en: "Each win scores by finish — 1 to 3 ★; take the whole match for +2 more." },
  ...
  "arena.rules":  { zh: "击飞两分，爆裂两分，极限三分，停转一分。先得四分者获胜。",
    py: ["jī","fēi","liǎng","fēn","bào","liè","liǎng","fēn","jí","xiàn","sān","fēn","tíng","zhuàn","yī","fēn","xiān","dé","sì","fēn","zhě","huò","shèng"],
    en: "Over +2, Burst +2, Xtreme +3, Spin +1. First to 4 points wins." },
